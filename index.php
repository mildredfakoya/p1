...
As a child I dreamt of being a Medical Doctor. I thought at that time, that was my desire. After I graduated from the University with my degree, I felt something was missing. Was it my unfulfilled passion for wanting to be a doctor? I didn't yet understand what it was.
</p>
<p>One year after Graduation, I was employed at a bank as a relationship officer. I spent 1 year at this job and resigned because i felt no sense of fulfillment.<br/>Long story short, I decided to put my degree to use. I started some self trainning in programming. I started with Visual Basic and C then JAVA, MySQl, HTML, CSS, JavaScript, PHP and some few others. I started to feel Fulfilled but there was something more.<br/>I wanted to be a developer for Health Information Systems. The realization of this gave me the type of fulfillment that i have been longing for.
...
<p>I spent the next 6 months after my certification exams at a teaching hospital. I wanted an industrial attachment in Pathology to understand basically bacterial infections, the types of screenings used to detect them, the sensitivity to antibiotics and so on. i needed this knowledge for the first software i wanted to build. i gathered all the knowledgde i wanted and left after 6 months.
